...
class AcneDetector:
    ...
    def plot_contours(self, original_image, peaks):
        ...
        self.show_debug_image("Detected Contours", original_image)
    ...
    def plot_3d_map(self, a_channel, block_size=3):
        ...
        a_channel_smoothed = cv2.GaussianBlur(a_channel, (7, 7), sigmaX=2, sigmaY=2)
...
if __name__ == "__main__":
    try:
        ...
        peaks = acne_detector.detect_peaks(gradient_magnitude, laplacian, red_mask)
        acne_detector.plot_contours(original_image, peaks)  # Draw circles around the detected peaks
